...
switch ($usergroup) {
  ...
  case 'Class reps':
			# code...
  echo'<li class="nav-item" data-toggle="tooltip" data-placement="right" title="Class Timetable">
  <a class="nav-link" href="class_time_table_view.php">
  <i class="fa fa-fw fa-file"></i>
  <span class="nav-link-text">Class Time Table</span>
  </a>
  </li>
  <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Exam Timetable">
  <a class="nav-link" href="exam_time_table_view.php">
  <i class="fa fa-fw fa-book"></i>
  <span class="nav-link-text">Exam Time Table</span>
  </a>
  </li>
  <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Exam Timetable">
  ...
  <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Class Timetable">
  <a class="nav-link" href="class_time_table_view.php">
  <i class="fa fa-fw fa-file"></i>
  <span class="nav-link-text">Class Time Table</span>
  </a>
