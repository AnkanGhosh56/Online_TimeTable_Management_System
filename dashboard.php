...
<head>
  ...
  <title>Software Lab Project</title>
  <!-- Bootstrap core CSS-->
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="index.html">Timetable Management</a>
    ...
    <footer class="sticky-footer">
      <div class="container">
        <div class="text-center">
          <small>Copyright ©. <a target="_blank" href="https://github.com/AnkanGhosh56" data-show-count="true">Ankan Ghosh</a></small>
        </div>
      </div>
    </footer>
